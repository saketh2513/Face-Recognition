#! python3
"""
@author: KOYYA SAKETH VENKATA SAI
...
-------------------------------------------------------------------------------
Description : 
MP3 Player is a python tkinter based music player which you can use to
...
if __name__ == '__main__':
	...
	pause = PhotoImage(file='icons/play.gif')
	play = PhotoImage(file='icons/pause.gif')
